                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 text-align=centre;">
                        <div class="modal-body">
							...
							<br>
							<form action="http://127.0.0.1/asif/shop/index.php" method="get" style="margin-top:100px;margin-bottom:-50px;"  novalidate>
								<div class="row control-group"  width=100% style="margin-left:0px; margin-right:0px;">
									<div class="form-group col-md-10 floating-label-form-group controls">
										<input type="text" class="form-control" placeholder="Search for Shops,Products"  name="name" id="search_tag" required data-validation-required-message="Enter a shop name, shop type, shop item">
										<p class="help-block text-danger"></p>
									</div>
									<div class="col-md-2">
										<button type="submit" style="margin-top:0px;" class="btn btn-success btn-lg"><i class="fa fa-fw fa-shopping-bag"></i> Shop</button>
									</div>
								</div>
