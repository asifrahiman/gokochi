        ...
        <!-- Projects Row -->
            ...
            <div class="col-md-3" id="proddesc<?php echo $row["name"]?><?php echo $row["shop_id"]?>">
                <div class="thumbnail" ><a href="proddesc/index.php?name=<?php echo $row["name"]?>&id=<?php echo $row["shop_id"]?>">
						...
						<form accept-charset="UTF-8" action="removecart.php" id="prodr<?php echo $row["name"]?><?php echo $row["shop_id"]?>" method="post" >
	 ...
	 var ab=parseInt(<?php echo $sum1;?>);
		<?php   if(isset($_SESSION['user_name'])){$username=$_SESSION['user_name'];
				...
				while($row = $result->fetch_assoc()) {?>
								...
								var ad<?php echo $row["name"]?><?php echo $row["id"]?>=parseInt(document.getElementById("oqty<?php echo $row["name"]?><?php echo $row["id"]?>").value);
								var ae<?php echo $row["name"]?><?php echo $row["id"]?>=parseInt(document.getElementById("price<?php echo $row["name"]?><?php echo $row["id"]?>").value);
								$("#changeqty<?php echo $row["name"]?><?php echo $row["id"]?>").submit(function(e) {
									var url = "changecart.php"; // the script where you handle the form input.
									$.ajax({
											   type: "POST",
											   url: url,
											   data: $("#changeqty<?php echo $row["name"]?><?php echo $row["id"]?>").serialize(), // serializes the form's elements.
											   success: function change(data)
											  {	var aa=".   Quantity-";
											    aa+=document.getElementById("qty<?php echo $row["name"]?><?php echo $row["id"]?>").value;
												var ac<?php echo $row["name"]?><?php echo $row["id"]?>=parseInt(document.getElementById("qty<?php echo $row["name"]?><?php echo $row["id"]?>").value);
												ab-=ad<?php echo $row["name"]?><?php echo $row["id"]?>*ae<?php echo $row["name"]?><?php echo $row["id"]?>;
												ab+=ac<?php echo $row["name"]?><?php echo $row["id"]?>*ae<?php echo $row["name"]?><?php echo $row["id"]?>;
												var af="Total Payable<i class=\"fa fa-fw fa-inr\"></i>";
												af+=ab;
												ad<?php echo $row["name"]?><?php echo $row["id"]?>=ac<?php echo $row["name"]?><?php echo $row["id"]?>;
												document.getElementById("changeqtystatus<?php echo $row["name"]?><?php echo $row["id"]?>").innerHTML = data;
												document.getElementById("updatedqty<?php echo $row["name"]?><?php echo $row["id"]?>").innerHTML = aa;
												document.getElementById("totpay").innerHTML = af;
												$("#changeqty<?php echo $row["name"]?><?php echo $row["id"]?>").trigger("reset");
											  }
										  });
									e.preventDefault(); // avoid to execute the actual submit of the form.
								});
								 $("#prodr<?php echo $row["name"]?><?php echo $row["id"]?>").submit(function(e) {
								...
								$.ajax({
									   type: "POST",
									   url: url,
									   data: $("#prodr<?php echo $row["name"]?><?php echo $row["id"]?>").serialize(), // serializes the form's elements.
									   success: function change(data)
									  {document.getElementById("proddesc<?php echo $row["name"]?><?php echo $row["id"]?>").innerHTML ="";
									   ab-=ad<?php echo $row["name"]?><?php echo $row["id"]?>*ae<?php echo $row["name"]?><?php echo $row["id"]?>;
									   if(ab)
									   {var af="Total Payable<i class=\"fa fa-fw fa-inr\"></i>";
										af+=ab;
									   document.getElementById("totpay").innerHTML = af;}
										...
										$('#prodr<?php echo $row["name"]?><?php echo $row["id"]?>').trigger("reset");}
