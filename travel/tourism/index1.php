    ...
    <header id="myCarousel" class="carousel slide" style="height: 75%;">
        ...
        <div class="carousel-inner">
            ...
            <div class="item">
                ...
                <div class="fill" style="background-image:url('../travelmain/getimg.php?id=8');"></div>
                <div class="carousel-caption">
            ...
            <div class="item">
                ...
                <div class="fill" style="background-image:url('../hotel/getimg.php?id=1');"></div>
                <div class="carousel-caption">
                    <h2>Le Meridian Hotel</h2>
                </div>
            </div>
			<div class="item">
                
                <div class="fill" style="background-image:url('../entertainment/getimg.php?id=1');"></div>
                <div class="carousel-caption">
                    <h2>Lulu</h2>
                </div>
            </div>
			<div class="item">
                ...
                <div class="fill" style="background-image:url('../entertainment/getimg.php?id=6');"></div>
                <div class="carousel-caption">
                    <h2>Cinepolis</h2>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
			<div class="col-lg-4">
				...
				<div class="col-lg-12 col-sm-12 text-center">
					<img class="img-circle img-responsive img-center" src="../entertainment/getimg.php?id=1" alt="">
					<h3>Lulu Mall
				...
				<div class="col-lg-12 col-sm-12 text-center">
					<img class="img-circle img-responsive img-center" src="../hotel/getimg.php?id=1" alt="">
					<h3>Le Meridian Hotel
			...
			<div class="col-lg-4">
				...
				<div class="col-lg-12 col-sm-12 text-center">
					<img class="img-circle img-responsive img-center" src="../entertainment/getimg.php?id=6" alt="">
					<h3>Cinepolis Cinema
						<small>10:00- </small>
					</h3>
					<p>Quisque sit amet fermentum massa. Nulla faucibus sagittis dui eget pretium. Suspendisse scelerisque, nibh nec consectetur tincidunt, velit ipsum auctor dui,</p>
