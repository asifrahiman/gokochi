...
<body>
    ...
    <header id="myCarousel" class="carousel slide" style="height: 75%;">
        ...
        <div class="carousel-inner">
            ...
            <div class="item">
                ...
                <div class="fill" style="background-image:url('../hotel/getimg.php?id=4');"></div>
                <div class="carousel-caption">
                    <h2>Marriot Hotel</h2>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">4 days and 3 nights
