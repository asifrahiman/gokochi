...
<body>
	...
	<div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <h1 class="page-header"> Spa & Wellness
        ...
        <div class="download-section">
            <div class="container">
                <div class="col-lg-8 col-lg-offset-2">
                    <h2>Hit the Spa and Resorts in Kochi!</h2>
			...
			<div class="row">
				...
				<?php 
					...
					<div class="col-sm-4 col-lg-4 col-md-4">
						<a data-toggle="modal" data-target="#exampleModal" data-name="<?php echo $row["name"]?>" data-description="<?php echo $row["description"]?>" data-latitude="<?php echo $row["latitude"]?>" data-longtitude="<?php echo $row["longtitude"]?>" data-id="<?php echo $row["id"]?>">
							<img class="img-responsive" style="width: 400px; height: 260px;" src="getimg.php?id=<?php echo $row["id"]?>" alt="">
