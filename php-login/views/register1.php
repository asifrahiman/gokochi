...
<form method="post" enctype="multipart/form-data" action="register.php" name="registerform"style="margin-top:140px;">
	<div class="container" style="margin-top:50px;">
        <div class="row">
			...
			<a href="http://127.0.0.1/asif/" class="login-btn" style="text-align:center;margin-bottom:50px;margin-left:525px;"><i class="fa fa-fw fa-arrow-left"></i> Back</a>
	 </div>
</form>
            ...
            <br>    
		<a href="http://127.0.0.1/asif/" class="login-btn" style="text-align:center;margin-bottom:50px;margin-left:600px;"><i class="fa fa-fw fa-arrow-left"></i> Back</a>
